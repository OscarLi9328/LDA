...
function h = visualizeBoundariesFill(MdlLinear,featureVector,labels,featureA,featureB,k)
%%
clf
nPoints = 100;
...
% x_proj = repmat(featureVector,);
pred = classify_Fisher(featureVector_for_prediction, featureVector, labels, k);
